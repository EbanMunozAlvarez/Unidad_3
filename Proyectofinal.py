...
# Cambiar los botones a color negro con texto blanco
estilo.configure("TButton",
                 font=("Arial", 12),        # Fuente de 12 puntos
                 padding=10,                # Espaciado interno
                 background="black",       # Fondo negro
                 foreground="black",       # Texto blanco
                 relief="flat")             # Sin relieve (estilo plano)

# Cambiar el color del botón cuando el ratón pasa por encima
estilo.map("TButton", background=[("active", "#333333")])  # Gris oscuro al pasar el ratón
